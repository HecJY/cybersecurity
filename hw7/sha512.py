...
class SHA(object):
    ...
    #This part is to write a function that hashes 512 bits
    def sha512(self):

        # THIS PART IS GIVEN BY THE CODE FROM LETCURE WHERE THE PAGE NUMBER IS 43 TO EXPLAIN
        ...
        #  THIS PART IS TO GENERATE THE 1024 input message block
        #  The K constants (also referred to as the "round constants") are used in round-based processing
        #  of each 1024-bit input message block.  There is a 32-bit constant for each of the 64 rounds.
        ...
        # 80 rounds of the processing is required, this is found on pg45 lecture 15
        ...
        #  STEP 1 OF THE HASHING ALGORITHM: Pad the message so that its length is an integral multiple of 1024
        ...
        for n in range(0, bv4.length(), 1024):
            ...
            #  STEP 2 OF THE HASHING ALGORITHM: Generate the message schedule required for processing a 1024-bit
            ...
            for i in range(16, 80):
                ...
                # THIS CAN BE FOUND IN PAGE 44 OF LEFTURE 15
            ...
            for i in range(80):
                ...
                #THIS PART CAN BE FOUND ON PAGE 46 LECTURE 15
...
def main():
    if(len(sys.argv) != 3):
        raise ValueError("The input requires 3 arguments")

    #read the contect from the input file
    file_in = sys.argv[1]
    f_i = open(file_in, "r")
    file_out = sys.argv[2]
    message= f_i.read()
